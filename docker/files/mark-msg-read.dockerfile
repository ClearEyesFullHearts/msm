...
COPY ./package*.json ./
COPY ./apps/sqs/messageRead/package*.json ./apps/sqs/messageRead/
...
COPY ./apps/sqs/messageRead/config ${LAMBDA_TASK_ROOT}/config
COPY ./apps/sqs/messageRead/index.js ${LAMBDA_TASK_ROOT}/index.js
