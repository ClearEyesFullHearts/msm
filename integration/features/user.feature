...
Scenario: I cannot register 2 users with the same username
    Given I load up random public keys
    And I set body to { "at": "testUser1", "key":`EPK`, "signature":`SPK`, "hash":"`SHA`" }
    And I POST to /users
    Given I load up random public keys
    And I set body to { "at": "testUser1", "key":`EPK`, "signature":`SPK`, "hash":"`SHA`" }
    When I POST to /users
...
Scenario: Usernames are case-sensitive
    Given I load up random public keys
    And I set body to { "at": "testuser2", "key":`EPK`, "signature":`SPK`, "hash":"`SHA`" }
    And I POST to /users
    Given I load up random public keys
    And I set body to { "at": "testUser2", "key":`EPK`, "signature":`SPK`, "hash":"`SHA`" }
    When I POST to /users
...
Scenario: Key should not be less than 788 characters
    ...
    And I load up random public keys
    And I set body to { "at": "testuser3", "key":"`KEY_TOO_SHORT`", "signature":`SPK`, "hash":"`SHA`" }
    When I POST to /users
    Then response code should be 400
    And response body path $.code should be BAD_REQUEST_FORMAT
...
Scenario: Key should not be more than 788 characters
    ...
    And I load up random public keys
    And I set body to { "at": "testuser4", "key":"`KEY_TOO_LONG`", "signature":`SPK`, "hash":"`SHA`" }
    When I POST to /users
    Then response code should be 400
    And response body path $.code should be BAD_REQUEST_FORMAT
...
Scenario: Key should be in a PK format
    ...
    And I load up random public keys
    And I set body to { "at": "testuser5", "key":"`KEY_NO_FORMAT`", "signature":`SPK`, "hash":"`SHA`" }
    When I POST to /users
    Then response code should be 400
    And response body path $.code should be BAD_REQUEST_FORMAT
...
Scenario: Signature should not be less than 268 characters
    ...
    And I load up random public keys
    And I set body to { "at": "testuser6", "key":`EPK`, "signature":"`SIG_TOO_SHORT`", "hash":"`SHA`" }
    When I POST to /users
    Then response code should be 400
    And response body path $.code should be BAD_REQUEST_FORMAT
...
Scenario: Signature should not be more than 268 characters
    ...
    And I load up random public keys
    And I set body to { "at": "testuser7", "key":`EPK`, "signature":"`SIG_TOO_LONG`", "hash":"`SHA`" }
    When I POST to /users
    Then response code should be 400
    And response body path $.code should be BAD_REQUEST_FORMAT
...
Scenario: Signature should be in a PK format
    ...
    And I load up random public keys
    And I set body to { "at": "testuser8", "key":`EPK`, "signature":"`SIG_NO_FORMAT`", "hash":"`SHA`" }
    When I POST to /users
    Then response code should be 400
    And response body path $.code should be BAD_REQUEST_FORMAT
...
Scenario: Hash should not be less than 172 characters
    ...
    And I load up random public keys
    And I set body to { "at": "testuser9", "key":`EPK`, "signature":`SPK`, "hash":"`SHA_TOO_SHORT`" }
    When I POST to /users
    Then response code should be 400
    And response body path $.code should be BAD_REQUEST_FORMAT
...
Scenario: Hash should not be more than 172 characters
    ...
    And I load up random public keys
    And I set body to { "at": "testuser10", "key":`EPK`, "signature":`SPK`, "hash":"`SHA_TOO_LONG`" }
    When I POST to /users
    Then response code should be 400
    And response body path $.code should be BAD_REQUEST_FORMAT
...
Scenario: Hash should be a base64 string
    ...
    And I load up random public keys
    And I set body to { "at": "testuser11", "key":`EPK`, "signature":`SPK`, "hash":"`SHA_PLAIN_TEXT`" }
    When I POST to /users
    Then response code should be 400
    And response body path $.code should be BAD_REQUEST_FORMAT
...
Scenario: I cannot register 2 users with the same encryption key
    ...
    And I set body to { "at": "testuser12", "key":`NEW_EPK`, "signature":`SPK`, "hash":"`COMPUTED_SHA`" }
    When I POST to /users
    Then response code should be 403
    And response body path $.code should be USER_EXISTS
